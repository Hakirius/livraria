...
public class EditoraController extends HttpServlet {
    ...
    private void apresentaFormEdicao(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("editora", editora); // Manda a editora para o formulário
        RequestDispatcher dispatcher = request.getRequestDispatcher("/editora/formulario.jsp");
        dispatcher.forward(request, response);
    }
    ...
    // Nessa parte, eu achei útil lançar um aviso quando a editoras possuir livros apontados para ela. Antes aparecia apenas erro.
    private void remove(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (e.getErrorCode() == 1451) {
                request.setAttribute("mensagens", "Esta editora possui livros cadastrados e não pode ser excluída!");
                lista(request, response);
            } else {
                throw new ServletException(e);
            }
